...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/providenetwork/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/providenetwork/tendermint/config/tendermint"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/providenetwork/tendermint/libs/bits"
