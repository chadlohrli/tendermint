...
import (
	...
	"github.com/providenetwork/tendermint/libs/async"
	tmprivval "github.com/providenetwork/tendermint/proto/tendermint/privval"
)
...
// https://github.com/providenetwork/tendermint/issues/4698
...
// See https://github.com/providenetwork/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/providenetwork/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/providenetwork/tendermint/issues/3531
