...
script](https://github.com/providenetwork/tendermint/blob/master/networks/remote/integration.sh)
...
```sh
cd $GOPATH/src/github.com/providenetwork/tendermint/networks/remote/terraform
```
...
directory](https://github.com/providenetwork/tendermint/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/providenetwork/tendermint/networks/remote/ansible`).
...
```sh
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/providenetwork/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/providenetwork/tendermint/networks/remote/ansible/mytestnet
```
