...
(ABCI)](https://github.com/providenetwork/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/providenetwork/tendermint) (the
...
Types](https://github.com/providenetwork/tendermint/blob/master/abci/README.md#message-types).
