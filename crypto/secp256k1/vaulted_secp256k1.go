...
const VaultedPrivateKeyName = "tendermint/VaultedPrivKeySecp256k1"
const VaultedPublicKeyName = "tendermint/VaultedPubKeySecp256k1"
...
func (k *VaultedPublicKey) String() string {
	return fmt.Sprintf("PubKeySecp256k1{%X}", k.Bytes())
}
