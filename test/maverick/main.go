...
import (
	...
	cmd "github.com/providenetwork/tendermint/cmd/tendermint/commands"
	"github.com/providenetwork/tendermint/cmd/tendermint/commands/debug"
	cfg "github.com/providenetwork/tendermint/config"
	"github.com/providenetwork/tendermint/libs/cli"
	tmflags "github.com/providenetwork/tendermint/libs/cli/flags"
	...
	nd "github.com/providenetwork/tendermint/test/maverick/node"
...
func initFilesWithConfig(config *cfg.Config) error {
	...
	if tmos.FileExists(nodeKeyFile) {
		...
		if _, err := p2p.LoadOrGenNodeKey(nodeKeyFile, config.VaultRefreshToken, vaultID, vaultKeyID); err != nil {
			return err
		}
