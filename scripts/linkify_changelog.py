...
# " [\#number](https://github.com/providenetwork/tendermint/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://github.com/providenetwork/tendermint/issues/\1)", line.rstrip())
    print(line)